...
{
  ProjetUnivers::Kernel::Parameters::load("input.config") ;
  ...
  std::ofstream outputFile("tests_input.xml");
  ...
  outputter->add(new ProjetUnivers::Kernel::XmlOutputter(&runner,outputFile,"Input")) ;
