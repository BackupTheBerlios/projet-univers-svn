  ...
  namespace Sound 
  {
    namespace Implementation 
    {
      namespace OpenAL 
      {
        ...
        /// Ogg file stream read once for all. 
        class OggCachedStream : public Stream
        {
        public:
        /*!
         @name Construction 
        ...
        // @{
          ...
          /// Constructor.
          OggCachedStream(const std::string& file_name) ;
        ...
        private:
          ...
          bool loadBuffer(OggVorbis_File* m_stream,ALuint buffer) ;
