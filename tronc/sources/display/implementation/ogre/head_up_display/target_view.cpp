...
#include <display/implementation/ogre/head_up_display/target_view.h>
    ...
    namespace Implementation {
      namespace Ogre {
        namespace HeadUpDisplay {
          ...
          : Kernel::TraitView<Target,TargetDisplayerViewPoint>(object,viewpoint),
            m_is_shown(false)
          {}
          
          void TargetView::onInit()
          {
            InternalMessage("Display","Entering TargetView::onInit") ;
            ...
            InternalMessage("Display","Leaving TargetView::onInit") ;
          }
          
          void TargetView::onClose()
          {
            if (m_container)
            {
          ...
          void TargetView::onUpdate()
          {
            if (isSelected())
            {
              InternalMessage("Display","TargetView::updateHUD calculating reticule position") ;
              ...
              InternalMessage("Display","TargetView::onUpdate object position="
              ...
              InternalMessage("Display","TargetView::updateHUD eye position="
              ...
              InternalMessage("Display","TargetView::updateHUD calculating reticule size") ;
              ...
              if (eye_position.z < 0)
              {
                ...
                */
                ...
                InternalMessage(
                  "Display","TargetView::updateHUD radius="
                ...
                InternalMessage(
                  "Display","TargetView::updateHUD dimension x="
          ...
          bool TargetView::isSelected() const
          {
