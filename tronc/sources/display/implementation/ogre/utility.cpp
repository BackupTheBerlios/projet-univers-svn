    ...
    namespace Implementation {
      namespace Ogre {
        ...
        namespace Utility
        {
          ...
          {
            return "PU::Display::Name" + toString(m_number++) ;
          }
...
//          void CreerSphere(const std::string& strName, 
//                           const float r, 
//                           const int nRings = 16, 
//                           const int nSegments = 16)
//          {
//            MeshPtr pSphere = MeshManager::getSingleton().
//              createManual(strName,
...
//            pSphere->_setBounds(AxisAlignedBox(Vector3(-r, -r, -r), 
//                                               Vector3(r, r, r) ), 
//                                               false);
