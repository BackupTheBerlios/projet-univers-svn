...
{
  ProjetUnivers::Kernel::Parameters::load("display_performance.config") ;
  ...
  std::ofstream outputFile("tests_performance_display.xml");
  ...
  outputter->add(new ProjetUnivers::Kernel::XmlOutputter(&runner,outputFile,"PerformanceDisplay")) ;
