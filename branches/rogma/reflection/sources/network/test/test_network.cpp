...
{
  ProjetUnivers::Kernel::Parameters::load("network.config") ;
  ProjetUnivers::Kernel::Log::init() ;
  ProjetUnivers::Model::start() ;
  ProjetUnivers::Network::start() ;
  ...
  std::ofstream outputFile("tests_network.xml");
  ...
  outputter->add(new ProjetUnivers::Kernel::XmlOutputter(&runner,outputFile,"Network")) ;
  runner.setOutputter(outputter);

  // Run the test.
  bool wasSucessful = runner.run(test_name);

  ProjetUnivers::Network::terminate() ;
