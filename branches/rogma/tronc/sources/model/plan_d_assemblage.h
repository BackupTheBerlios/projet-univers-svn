...
namespace ProjetUnivers {
  ...
  namespace Model {
    ...
    class PlanDeCstd::stringomposant ;
    ...
    /*!
      ...
      @deprecated
    */
    class PlanDAssemblage : public Object
    {
    public:
    ...
    */
    ...
    // @{
      ...
      void add(const Base::Association<PlanDeComposant>&) ;
      void add(const Base::Association<PlanDeContrainte>&) ;
