...
namespace ProjetUnivers {
  namespace Model {
    ...
    @deprecated
    */
    class PlanDeComposant : public Object
    {
    public:
    ...
    */
    ...
    private:
      ...
      /*!
        ...
        @todo
          add les états pour les modèles destructibles. A réaliser. 
          
        Pour chaque état :
        - Un modèle 3D
        - Des points d'attaches 
      */
      /// Base::FonctionAssociationValeurObject<Base::Entier,PlanDEtatDeComposant> etats ;
