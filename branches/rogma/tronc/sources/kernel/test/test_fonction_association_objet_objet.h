...
namespace ProjetUnivers {
  ...
  namespace Base {
    ...
    namespace Test {
      ...
      ///  Test de Base::FonctionAssociationObjectObject.
      class TestFonctionAssociationObjectObject : public CppUnit::TestFixture {
      protected:
        ...
        CPPUNIT_TEST_SUITE(TestFonctionAssociationObjectObject) ;
