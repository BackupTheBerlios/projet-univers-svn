  ...
  namespace Base {
    ...
    namespace Test {
      ...
      namespace {
        ...
        unsigned int Object::nombreDInstance = 0 ;
      ...
      void TestAgregation::testDestructionAutomatique()
      {
        ...
        Agregation<Object> o1(new Object()) ;

        {
          Agregation<Object> o2 = o1 ;
          
          
        }
        
        CPPUNIT_ASSERT(Object::nombreDInstance == 1) ;

        /// plus personne ne point sur l'objet
        o1 = NULL ;
        
        CPPUNIT_ASSERT(Object::nombreDInstance == 0) ;
