...
namespace ProjetUnivers {
  ...
  namespace Base {
    ...
    namespace Test {
      ...
      ///  Test de Base::FonctionCompositionValeurObject.
      class TestFonctionCompositionValeurObject 
      ...
      // @{      
        ...
        /// Teste le vidage de la fonction.
        void testVider();
      ...
      // @{
        ...
        CPPUNIT_TEST_SUITE(TestFonctionCompositionValeurObject) ;
