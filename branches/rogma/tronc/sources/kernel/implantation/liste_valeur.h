    ...
    namespace Implantation {    
      ...
      */
      ...
      public:
        ...
        void addEnTete(const VALEUR& _element);
      
        /// Ajoute des éléments à la liste en première position.
        void addEnTete(const ListeValeur<VALEUR>& _liste) ;
      
        /// Ajoute un élément à la liste en dernière position.
        void addEnQueue(const VALEUR& _elt);
      
        /// Enlève l'élément à la position _position.
        void remove(const EntierPositif& _position) ;
